    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          UserSection(
              icon_name: Icons.credit_card, section_text: "Credit Card"),
          UserSection(
              icon_name: Icons.shopping_basket, section_text: "Past orders"),
          UserSection(
              icon_name: Icons.location_city,
              section_text: "Address information"),
          UserSection(
              icon_name: Icons.wallet_giftcard, section_text: "Coupons"),
        ],
      ),
    );
  }
